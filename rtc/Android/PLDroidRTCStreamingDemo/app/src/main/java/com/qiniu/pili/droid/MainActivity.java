...
import com.qiniu.pili.droid.rtcunion.demo.openlive.ui.UNRTCEntryActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickUNRTCConference(View v) {
        Intent intent = new Intent(MainActivity.this, UNRTCEntryActivity.class);
        startActivity(intent);
    }
